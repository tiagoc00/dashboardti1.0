  ...
  <aside class="w-[272px] shrink-0 bg-surface border-r border-border flex flex-col py-6 px-[18px] gap-5 sticky top-0 h-screen overflow-y-auto hidden md:flex">
    <div class="flex items-center gap-2.5">
      ...
      <div>
        ...
        <p class="text-[13px] text-text font-bold">Gestão de Chamados</p>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-2">
      <p class="font-mono text-[12px] tracking-[1.5px] uppercase text-text font-bold pb-1.5 border-b border-border">Configurações</p>
    ...
    <div class="flex flex-col gap-2">
      <p class="font-mono text-[12px] tracking-[1.5px] uppercase text-text font-bold pb-1.5 border-b border-border">Banco de Dados</p>
    ...
    <div class="flex flex-col gap-2">
      <p class="font-mono text-[12px] tracking-[1.3px] uppercase text-text font-bold pb-1.5 border-b border-border">Importar Dados</p>
